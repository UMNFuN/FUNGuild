...
An example OTU table file to demonstrate formatting can be found <a href='www.stbates.org/guilds/download_examples.php/?download_file=otu_table_example.txt' target = '_blank'><i>here</i></a>.
...
Consult the example OTU table file for a more complete OTU file formatting representation <a href='www.stbates.org/guilds/download_examples.php/?download_file=otu_table_example.txt' target = '_blank'><i>here</i></a>.
